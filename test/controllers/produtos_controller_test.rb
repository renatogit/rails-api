...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { cod_barras: @produto.cod_barras, nome: @produto.nome, val_unitario: @produto.val_unitario } }, as: :json
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { cod_barras: @produto.cod_barras, nome: @produto.nome, val_unitario: @produto.val_unitario } }, as: :json
    assert_response 200
  end
